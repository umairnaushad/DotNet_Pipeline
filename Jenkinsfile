            ...
            steps {
                script {                    
                    ...
                    */
                    ...
                    bat "msbuild.exe \"${WORKSPACE}\\Source\\VS Solution\\Desktop Application1.sln\" /p:Configuration=Release /p:Platform=\"Any CPU\" /p:ProductVersion=1.0.0.${env.BUILD_NUMBER}"
